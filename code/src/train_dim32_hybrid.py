"""dim=32 Hybrid training"""
import os, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
import config_stock_emb_8
config_stock_emb_8.STOCK_EMBED_DIM = 32
for ec in config_stock_emb_8.EXPERT_CONFIGS:
    ec['stock_embed_dim'] = 32

from config_stock_emb_8 import *
from train_stock_emb_8_loss import main
import numpy as np, pandas as pd, torch, joblib, json, gc, argparse
from train import feature_cloums_map, feature_engineer_func_map, _build_label_and_clean, set_seed
from ensemble_models import StockTransformerExpert, ConvStockExpert
from train_stock_emb_8_loss import preprocess_with_winsor, train_expert, \
    create_ranking_dataset_vectorized, RankingDataset
...
print(f"dim=32 Hybrid Training | Device: {device}")
set_seed(42)

output_dir = os.path.join('./model', 'stock_emb_32_hybrid')
