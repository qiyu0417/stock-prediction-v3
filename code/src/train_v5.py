"""
V5 训练: 增强 Transformer 专家 (nhead=8, FFN=4x) + Winsorization
- 复用 V2 训练引擎 (train_v2.py 的 _train_step / _train_chunked / train_expert)
- 只改: config 容量 + Winsorization 预处理
"""
...
def main():
    ...
    print("\n预处理 (Winsorization + StandardScaler)...")
